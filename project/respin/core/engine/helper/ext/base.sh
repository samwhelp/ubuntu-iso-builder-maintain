...
base_var_init () {
	...
	DEFAULT_REPO_PREFIX_NAME="ubuntu-iso-builder-respin"
	...
	DEFAULT_WORK_DIR_PATH="${HOME}/iso-builder/ubuntu/respin"
	...
	DEFAULT_ENTITY_DESKTOP_LIST="xfce kde-plasma budgie mate cinnamon gnome-shell kde-plasma-theme-orchis mate-with-compiz lxqt lxqt-with-kwin"
