...
sys_repo_prepare_dir () {
	...
	local the_first_level_dir_name
	...
	for the_desktop_name in ${desktop_list}; do
		...
		the_first_level_dir_name="${prefix_name}-${the_desktop_name}"
		the_first_level_dir_path="${work_dir_path}/${the_first_level_dir_name}"
...
sys_repo_prepare_dir_and_clone_file () {
	...
	for the_desktop_name in ${desktop_list}; do
		...
		echo
		echo "create file: ${the_first_level_dir_path}/clone.sh"
		echo
		util_repo_create_clone_script_file "${the_first_level_dir_name}" "${the_first_level_dir_path}/clone.sh"
...
sys_repo_prepare_dir_and_clone_file_and_clone_repo () {
	...
	for the_desktop_name in ${desktop_list}; do
		...
		cd "${the_first_level_dir_path}"

		echo
		echo "clone repo: ${the_first_level_dir_path}/clone.sh"
		echo
		sh ./clone.sh
...
sys_repo_pull_all () {
	...
	for the_desktop_name in ${desktop_list}; do
		...
		cd "${the_first_level_dir_path}/${the_first_level_dir_name}-main"

		echo
		echo "git pull: ${the_first_level_dir_path}/${the_first_level_dir_name}-main"
		echo
		git pull || true
		...
		cd "${the_first_level_dir_path}/${the_first_level_dir_name}-gh-pages"

		echo
		echo "git pull: ${the_first_level_dir_path}/${the_first_level_dir_name}-gh-pages"
		echo
		git pull || true
...
sys_repo_push_all () {
	...
	for the_desktop_name in ${desktop_list}; do
		...
		echo
		echo "git push: ${the_first_level_dir_path}/${the_first_level_dir_name}-main"
		echo
		git push || true
		...
		echo
		echo "git push: ${the_first_level_dir_path}/${the_first_level_dir_name}-gh-pages"
		echo
		git push || true
...
sys_repo_overlay_main () {
	...
	for the_desktop_name in ${desktop_list}; do
		...
		target_dir_path="${the_first_level_dir_path}/${the_first_level_dir_name}-main"
...
sys_repo_overlay_gh_page () {
	...
	for the_desktop_name in ${desktop_list}; do
		...
		target_dir_path="${the_first_level_dir_path}/${the_first_level_dir_name}-gh-pages"
